<template>
  <header class="bg-gray-900">
    <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center  p-6 lg:px-8">
      ...
      <el-popover-group class="hidden lg:flex lg:gap-x-12">
        <a href="/" class="text-sm/6 font-semibold text-white">Inicio</a>
        <div class="relative">
          ...
          <el-popover id="desktop-menu-product" anchor="bottom" popover
            ...
            <div class="p-4">
              ...
              <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-white/5">
                ...
                <div class="flex-auto">
                  <a href="/clientes" class="block font-semibold text-white">
                    Clientes
                    <span class="absolute inset-0"></span>
                  </a>
                  <p class="mt-1 text-gray-400">Clientes registrados en las ordenes de carga</p>
                </div>
              </div>
              ...
              <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-white/5">
                ...
                <div class="flex-auto">
                  <a href="/productos" class="block font-semibold text-white">
                    Productos
                    <span class="absolute inset-0"></span>
                  </a>
                  <p class="mt-1 text-gray-400">Productos cargados en las ordenes de carga</p>
                </div>
              </div>
              ...
              <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-white/5">
                ...
                <div class="flex-auto">
                  <a href="/camiones" class="block font-semibold text-white">
                    Camiones
                    <span class="absolute inset-0"></span>
                  </a>
                  <p class="mt-1 text-gray-400">Camiones regisrados en las ordenes de carga</p>
                </div>
              </div>
              ...
              <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-white/5">
                ...
                <div class="flex-auto">
                  <a href="/choferes" class="block font-semibold text-white">
                    Choferes
                    <span class="absolute inset-0"></span>
                  </a>
                  <p class="mt-1 text-gray-400">Choferes registrados en las ordenes de carga</p>
                </div>
              </div>
        ...
        <a href="/conciliaciones" class="text-sm/6 font-semibold text-white">Conciliaciones</a>
        <a href="#" class="text-sm/6 font-semibold text-white">Sobre nosotros</a>
      </el-popover-group>
